...
public class BeanContaPoupancaCorrenteTest
{
   ...
   ContaPoupancaCorrente contaPoupCor = new ContaPoupancaCorrente(); // TODO: Nao está sendo usando
   ...
   public void testCreditoValorPositivo()
   {
      ...
      Mockito.when(daoContaPoupCor.salvar(Mockito.any())).thenReturn(null);
